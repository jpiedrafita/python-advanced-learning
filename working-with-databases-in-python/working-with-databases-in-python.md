...
Labels:  [[Dominio Técnico]] [[programación]] #Python #databases
...
- [1.1 SQLite Databases](01_Using_a_Local_Relational_Database_-_SQLite/1.1-SQLite-Databases.md)
- [1.2 Demo Starter Code Review](01_Using_a_Local_Relational_Database_-_SQLite/1.2-Demo-Starter-Code-Review.md)
- [1.3 Using the sqlite3 module](01_Using_a_Local_Relational_Database_-_SQLite/1.3-Using-the-sqlite3-module.md)
...
- [5.1 Using MongoDB in Visual Studio Code](05_Using_a_NoSQL_Database_-_MongoDB_and_PyMongo/5.1-Using-MongoDB-in-Visual-Studio-Code.md)
...
- [6.5 Demo Embedded Documents with MongoEngine](06_Using_a_ODM_-_MongoEngine/6.5-Demo-Embedded-Documens-with-MongoEngine.md)